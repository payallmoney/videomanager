...
func UserLogin(session sessions.Session, db *sql.DB, r render.Render, req *http.Request) {
...
func UserAuth(session sessions.Session, c martini.Context, r render.Render) {
